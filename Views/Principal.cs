...
namespace Views
{
    public partial class Principal : Form
    {
        ...
        {
            controlDeAccesos();
            lblNombreUser.Text = username;
        }

        
        private void controlDeAccesos()
        {
            if (rol == "Administrador")
            {
                MenuAutos.Enabled = true;
                MenuEmpleado.Enabled = true;
            }
            else if (rol == "Empleado")
            {
                MenuAutos.Enabled = false;
                MenuEmpleado.Enabled = false;
            }
        }
